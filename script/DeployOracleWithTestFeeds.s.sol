...
contract DeployOracleWithTestFeeds is Script {
    function run() external {
        ...
        console.log("PriceLoomOracle deployed at:", address(oracle));
        ...
        console.log("Created feed 'AR/byte' with ID:", arBytesFeedId);

        bytes32 arUsdFeedId = keccak256("AR/USD");
        oracle.createFeed(arUsdFeedId, arUsdConfig, operators);
        console.log("Created feed 'AR/USD' with ID:", arUsdFeedId);
